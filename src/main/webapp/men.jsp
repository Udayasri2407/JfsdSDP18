 ...
 <head>
  ...
  <style>
   body {
            ...
            margin: 0;
            padding: 0;
            background: linear-gradient(to bottom, #00000, #0000ff);
        }
        .container {
            width: 90%;
            margin: 0 auto;
  ...
  <div class="container">
   ...
   <div class="filters">
    <div class="dropdown">
     ...
     <div class="dropdown-content">
      ...
      <a href="#" onclick="filterProducts('category', 'Men')">Basics</a>
   ...
   <div class="products" id="products">
    <div class="product" data-category="Men" data-type="Shirts" data-size="Medium" data-color="Blue" data-price="30">
     <img alt="A light blue scarf" height="400" src="https://m.media-amazon.com/images/I/71A1JzUz-1L._UF1000,1000_QL80_.jpg" width="300"/>
     <div class="cart-icon">
    ...
    <div class="product" data-category="Men" data-type="Shirts" data-size="Large" data-color="White" data-price="30">
     <img alt="A white shirt" height="400" src="https://rukminim2.flixcart.com/image/850/1000/l5h2xe80/book/y/j/o/best-motivational-books-in-english-ikigai-the-power-of-positive-original-imagg4vpegwxrjzh.jpeg?q=90&crop=false" width="300"/>
     <div class="cart-icon">
      <i class="fas fa-shopping-cart">
      </i>
     </div>
    ...
    <div class="product" data-category="Men" data-type="Shirts" data-size="Medium" data-color="Blue" data-price="30">
     <img alt="A blue plaid shirt" height="400" src="https://fourminutebooks.com/wp-content/uploads/2016/06/best-motivational-books-29-678x1024.jpg" width="300"/>
     <div class="cart-icon">
      <i class="fas fa-shopping-cart">
      </i>
     </div>
    ...
    <div class="product" data-category="Women" data-type="Shirts" data-size="Medium" data-color="Blue" data-price="30">
     <img alt="A blue polo shirt" height="400" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqxO5u9-GgbRyktjbQC0JBymU_0csqnk_OYA&s" width="300"/>
     <div class="cart-icon">
      <i class="fas fa-shopping-cart">
      </i>
     </div>
    ...
    <div class="product" data-category="Women" data-type="Accessories" data-size="Medium" data-color="Black" data-price="30">
     <img alt="A pair of black sunglasses" height="400" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRE64_XPw705ByJNmxQwJTCVsZd854dUq7RAg&s" width="300"/>
     <div class="cart-icon">
      <i class="fas fa-shopping-cart">
      </i>
     </div>
    ...
    <div class="product" data-category="Kids" data-type="Shirts" data-size="Small" data-color="White" data-price="30">
     <img alt="A white sweater with black patterns" height="400" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWenTMj8yqXT5CX8X9LbJj1AY7U9xVEnuyAA&s" width="300"/>
     <div class="cart-icon">
      <i class="fas fa-shopping-cart">
      </i>
     </div>
