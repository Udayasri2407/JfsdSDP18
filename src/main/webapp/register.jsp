  ...
  <div class="main-container">
    <div class="login-container">
      ...
      <form method="post" action="checkadminlogin">
        <table>
          <tr>
            <td><label for="auname">Id</label></td>
            <td><input type="text" id="auname" name="auname" placeholder="type your answer" required /></td>
          </tr>
          <tr>
            <td><label for="auname">Contact</label></td>
            <td><input type="text" id="auname" name="auname" placeholder="0000000000" required /></td>
          </tr>
          <tr>
            <td><label for="auname">Date of Birth</label></td>
            <td><input type="text" id="auname" name="auname" placeholder="DD/MM/YYYY" required /></td>
          </tr>
          <tr>
            <td><label for="auname">Email</label></td>
            <td><input type="text" id="auname" name="auname" placeholder="Enter your email address" required /></td>
          </tr>
          <tr>
            <td><label for="apwd">Gender</label></td>
            <td><input type="password" id="apwd" name="apwd" placeholder="Type your gender" required /></td>
          </tr>
          <tr>
            <td><label for="auname">Username</label></td>
